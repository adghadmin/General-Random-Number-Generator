...
HD_PWD='F:/1.work_user/1.noise_gen/noise_LCG/noise_LCG.runs/mult_a_x_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log mult_a_x.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source mult_a_x.tcl
