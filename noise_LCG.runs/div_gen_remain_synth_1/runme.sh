...
HD_PWD='F:/1.work_user/1.noise_gen/noise_LCG/noise_LCG.runs/div_gen_remain_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log div_gen_remain.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source div_gen_remain.tcl
