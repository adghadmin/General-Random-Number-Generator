...
/* Module Version: 5.7 */
/* C:\lscc\diamond\3.10_x64\ispfpga\bin\nt64\scuba.exe -w -n PLL_100MHz -lang verilog -synth lse -arch xo3c00a -type pll -fin 25 -fclkop 100 -fclkop_tol 0.0 -trimp 0 -phasep 0 -trimp_r -phase_cntl STATIC -fb_mode 1  */
/* Tue Jan 29 15:29:16 2019 */


`timescale 1 ns / 1 ps
module PLL_100MHz (CLKI, CLKOP)/* synthesis NGD_DRC_MASK=1 */;
    input wire CLKI;
    output wire CLKOP;
